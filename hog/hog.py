...
def swine_align(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 4a
    if not player_score or not opponent_score: # Special Case
        return False
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    # BEGIN PROBLEM 7
    def say(current_score_0, current_score_1):
        if who:
            if current_score_1-last_score > running_high:
                print(current_score_1-last_score, 'point(s)! The most yet for Player', who)
                return announce_highest(who, last_score=current_score_1, running_high = current_score_1-last_score)
            else:
                return announce_highest(who, last_score=current_score_1, running_high = running_high)
        else:
            if current_score_0-last_score > running_high:
                print(current_score_0-last_score, 'point(s)! The most yet for Player', who)
                return announce_highest(who, last_score=current_score_0, running_high = current_score_0-last_score)
            else:
                return announce_highest(who, last_score=current_score_0, running_high = running_high)
    return say
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    max_score = 0
    for i in range(10, 0, -1): # i (10 to 1) return the lower number when tie
